        ...
        <Card className="border-red-200 bg-red-50">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-red-800">
              ...
              {language === 'he' ? 'התראות תזרים' : 'Cash Flow Alerts'}
            </CardTitle>
          </CardHeader>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      {language === 'he' ? 'צפוי בעוד' : 'Expected in'} {alert.days_until} {language === 'he' ? 'ימים' : 'days'}
                      {' • '}
                      {new Date(alert.date).toLocaleDateString(language === 'he' ? 'he-IL' : 'en-US')}
                    </p>
                  </div>
                </div>
              </div>
